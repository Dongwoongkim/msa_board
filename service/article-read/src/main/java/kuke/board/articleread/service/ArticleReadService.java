...
public class ArticleReadService {
    ...
    public ArticleReadResponse read(Long articleId) {
        ...
        return ArticleReadResponse.from(articleQueryModel,
    ...
    private Optional<? extends ArticleQueryModel> fetch(Long articleId) {
        ...
        log.info("[ArticleReadService] fetch data. articleId = {}, isPresent={}", articleId, articleQueryModelOptional.isPresent());
